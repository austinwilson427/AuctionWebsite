    ...
    public partial class Something : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.ItemModels", t => t.ItemModelId)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.BidModels", "ItemModelId", "dbo.ItemModels");
            ...
            DropIndex("dbo.BidModels", new[] { "ItemModelId" });
